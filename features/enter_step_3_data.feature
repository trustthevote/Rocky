Feature: Step 3
  ...
  Background:
    ...
    Scenario: User sees RTV SMS opt-in options for partner 1
      Given I have completed step 2
      When I go to the step 3 page
      And I should see a checkbox for "Receive SMS"
      When I check "Receive SMS"
      And I press "registrant_submit"
      And I should not be signed up for "ask_for_opt_in_sms"
    ...
    Scenario: User sees RTV and partner SMS opt-in options for partner configured to have rtv and partner opt-ins, and checks partner-sms
      ...
      When I go to the step 3 page
      Then I should see a checkbox for "Receive SMS from Rock the Vote"
      And I should see a checkbox for "Receive SMS from Opt-in Partner"
