...
class Partner < ActiveRecord::Base
  ...
  def generate_registrants_csv_async
    ...
    Delayed::Job.enqueue(action, {:priority=>CSV_GENERATION_PRIORITY, :run_at=>Time.now})
  end
  ...
  def generate_registrants_csv_file
    ...
    Delayed::Job.enqueue(action, {:priority=>CSV_GENERATION_PRIORITY,:run_at=> AppConfig.partner_csv_expiration_minutes.from_now})
  end
